    ...
    <div className="article-page">
      <div className="banner">
        <div className="container">
          ...
          <div className="article-meta">
            <a href="/profile/eric-simons"><Image src={"http://i.imgur.com/Qr71crq.jpg"} alt={"eric-simons"} width={100} height={100} /></a>
            <div className="info">
      ...
      <div className="container page">
        ...
        <div className="article-actions">
          <div className="article-meta">
            <a href="profile.html"><Image src={"http://i.imgur.com/Qr71crq.jpg"} alt={"eric-simons"} width={100} height={100} /></a>
            <div className="info">
